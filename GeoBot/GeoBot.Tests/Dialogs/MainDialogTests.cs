...
namespace GeoBot.Tests.Dialogs
{
    public class MainDialogTests : BotTestBase
    {
        ...
        //{
        //    // Arrange
        //    var mockRecognizer = SimpleMockFactory.CreateMockLuisRecognizer<AddressRecognizer>(null, constructorParams: new Mock<IConfiguration>().Object);
        ...
        //    var mockLuisRecognizer = SimpleMockFactory.CreateMockLuisRecognizer<AddressRecognizer, FlightBooking>(
        //        new FlightBooking
        //        {
